...
- [C++20](#c20)
  ...
  - [C++20 语言特性](#c20-语言特性)
    - [Coroutine(协程)](#协程)
    - [Concept(概念)](#概念)
    - [Three-Way Comparison(三路比较)](#三路比较)
    - [Designated Initializer(指定初始化器)](#指定初始化器)
    - [Template Syntax for Lambdas(Lambda 的模板语法)](#lambda-的模板语法)
    - [Range-Based For Loop with Initializer(带初始化器的范围 for 循环)](#带初始化器的范围-for-循环)
    - [[[likely]] and [[unlikely]] Attributes([[likely]] 和 [[unlikely]] 属性)](#likely-和-unlikely-属性)
    - [Deprecate Implicit Capture of this(弃用隐式捕获 this)](#弃用隐式捕获-this)
    - [Class Types in Non-Type Template Parameters(非类型模板参数中的类类型)](#非类型模板参数中的类类型)
    - [Constexpr Virtual Function(constexpr 虚函数)](#constexpr-虚函数)
    - [explicit(bool)](#explicitbool)
    - [Immediate Function(立即函数)](#立即函数)
    - [using enum](#using-enum)
    - [Lambda Capture of Parameter Pack(Lambda 捕获参数包)](#lambda-捕获参数包)
    - [char8\_t](#char8_t)
    - [constinit](#constinit)
    - [\_\_VA\_OPT\_\_](#__va_opt__)
  - [C++20 标准库特性](#c20-标准库特性)
    - [Text Formatting(文本格式化)](#文本格式化)
    - [Concepts Library(概念库)](#概念库)
    - [Synchronized Buffered Output Stream(同步缓冲输出流)](#同步缓冲输出流)
    - [std::span](#stdspan)
    - [Bit Operation(位操作)](#位操作)
    - [Math Constants(数学常数)](#数学常数)
    - [std::is\_constant\_evaluated](#stdis_constant_evaluated)
    - [std::make\_shared 支持数组](#stdmake_shared-支持数组)
    - [字符串的 starts\_with 和 ends\_with](#字符串的-starts_with-和-ends_with)
    - [Check if Associative Container Has Element(检查关联容器是否包含元素)](#检查关联容器是否包含元素)
    - [std::bit\_cast](#stdbit_cast)
    - [std::midpoint](#stdmidpoint)
    - [std::to\_array](#stdto_array)
    - [std::bind\_front](#stdbind_front)
    - [Uniform Container Erasure(统一容器擦除)](#统一容器擦除)
    - [Three-Way Comparison Helpers(三路比较辅助函数)](#三路比较辅助函数)
    - [std::lexicographical\_compare\_three\_way](#stdlexicographical_compare_three_way)
    - [std::jthread](#stdjthread)
    - [Safe Integral Comparison(安全整数比较)](#安全整数比较)
  - [致谢](#致谢)
  - [作者](#作者)
  - [内容贡献者](#内容贡献者)
  - [许可证](#许可证)
